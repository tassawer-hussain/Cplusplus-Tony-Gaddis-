// Problem 022: Monthly Sales Tax Modification
...
int main()
{
	...
	ofstream fout;
	fout.open("file22.txt");
	fout<<setprecision(2)<<fixed<<showpoint;
	fout<<"\n\nYear: "<<year; 
	fout<<" Month: "<<month<<"\n";
	fout<<"--------------------\n";
	fout<<"Total Collected: $"<<amount<<"\n";
	fout<<"Sales: $"<<sale<<"\n";
	fout<<"County Sales Tax: $ "<<csTax<<"\n";
	fout<<"State Sales Tax: $ "<<ssTax<<"\n";
	fout<<"Total Sales Tax: $ "<<tsTax<<"\n";
